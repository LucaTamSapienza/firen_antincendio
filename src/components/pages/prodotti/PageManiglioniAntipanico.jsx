...
const PageManiglioniAntipanico = () => {
  return (
    <section className="w-full bg-white pb-10">
      <Hero image="/images/prodotti/maniglione-image.png" title="Maniglioni Antipanico" />
      <div className="max-w-4xl mx-auto py-12 px-4 flex flex-col md:flex-row items-center gap-10">
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <img src="/images/prodotti/maniglione-image.png" alt="Maniglioni Antipanico" className="object-cover w-full max-w-md rounded-xl shadow-lg" />
        </div>
