...
const PageEstintori = () => {
  return (
    <section className="w-full bg-white pb-10">
      <Hero image="/images/prodotti/estintore.jpg" title="Estintori" />
      <div className="max-w-4xl mx-auto py-12 px-4 flex flex-col md:flex-row items-center gap-10">
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <img src="/images/prodotti/estintore.jpg" alt="Estintore" className="object-cover w-full max-w-md rounded-xl shadow-lg" />
        </div>
